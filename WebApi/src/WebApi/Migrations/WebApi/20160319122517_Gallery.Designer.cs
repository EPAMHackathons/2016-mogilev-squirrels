...
namespace WebApi.Migrations.WebApi
{
    ...
    [Migration("20160319122517_Gallery")]
    partial class Gallery
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WebApi.Models.Action", b =>
                {
                    b.Property<string>("Id");

                    b.Property<string>("DayScheduleId");
            ...
            modelBuilder.Entity("WebApi.Models.DaySchedule", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("WebApi.Models.Gallery.DogProfile", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("WebApi.Models.UserSchedule", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("WebApi.Models.Action", b =>
                {
                    b.HasOne("WebApi.Models.DaySchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApi.Models.DaySchedule", b =>
                {
                    b.HasOne("WebApi.Models.UserSchedule")
                        .WithMany()
